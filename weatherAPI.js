  ...
  return (
    <View style={mapStyle}>
      ...
      <View style={styles.legend}>
        ...
        <Text style={{color: 'black'}}><FontAwesome5 name="square-full" size={16} style={{ color: 'green' }}/> Low</Text>
        <Text style={{ color: 'black' }}><FontAwesome5 name="square-full" size={16} style={{ color: 'orange' }}/> Medium</Text>
        <Text style={{ color: 'black' }}><FontAwesome5 name="square-full" size={16} style={{ color: 'red' }}/> High</Text>
